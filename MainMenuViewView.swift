//
// MainMenuViewView.swift
// Generated by Core Animator version 1.4 on 5/16/17.
//
...
private class MainMenuViewPassthroughView: UIView {
...
class MainMenuView : UIView, CAAnimationDelegate {
	...
	func setupHierarchy() {
		...
		let guidedZen__root = MainMenuViewPassthroughView()
		let guidedZen__xScale = MainMenuViewPassthroughView()
		let guidedZen__yScale = MainMenuViewPassthroughView()
		...
		let moodZen__root = MainMenuViewPassthroughView()
		let moodZen__xScale = MainMenuViewPassthroughView()
		let moodZen__yScale = MainMenuViewPassthroughView()
		...
		let openZen__root = MainMenuViewPassthroughView()
		let openZen__xScale = MainMenuViewPassthroughView()
		let openZen__yScale = MainMenuViewPassthroughView()
